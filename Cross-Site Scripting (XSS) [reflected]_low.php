...
<html lang="en">
  <head>
    ...
    <title>XSS Low | Hack The Point</title>
  </head>
  <body>
    <div class="header">
    ...
    <div class="login-container d-flex flex-column">
      <h2 class="align-self-center">Low Level XSS</h2>
      <div class="login-box">
        <form method="get" action="Cross-Site Scripting (XSS) [reflected]_low.php" class="form">
    ...
    <div class="result-section">
        <?php if (isset($search_term)) : ?>
            <p style="color:#00ff88"><?php echo $search_term; // XSS vulnerable ?></p>
        <?php endif; ?>
    </div>
