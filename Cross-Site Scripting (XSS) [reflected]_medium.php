...
if (isset($_GET['search'])) {
    ...
    // فلترة بسيطة <script> فقط
    $sanitized = str_replace('<script>', '', $search_input);
}
?>
...
<head>
  ...
  <link rel="stylesheet" href="css/sql.css"> <!-- نفس ملف CSS تبع Low -->
  <title>XSS Medium | Hack The Point</title>
</head>
<body>
  <div class="header">
  ...
  <div class="login-container d-flex flex-column">
    <h2 class="align-self-center">Medium Level XSS</h2>
    <div class="login-box">
      <form method="get" action="Cross-Site Scripting (XSS) [reflected]_medium.php" class="form">
      ...
      <div class="result mt-4">
        <?php if (isset($sanitized)) : ?>
          <p>You searched for: <?php echo $sanitized; ?></p>
        <?php endif; ?>
      </div>
    </div>
  </div>
